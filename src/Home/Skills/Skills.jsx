    ...
    return (
        <section id="skill">
            ...
            <div className="hero mx-auto  text-center my-12">
                <h3 className="text-3xl uppercase mx-auto w-1/3 border-y-4 py-4 z-[0]">My Skill Set</h3>
            </div>
            <div>
                <div className="mb-8 grid grid-cols-1 md:grid-cols-3 ml-8 gap-4" >
                    ...
                    <div data-aos="flip-left" className="z-0 h-[200px] w-[350px] p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center "  >
                    ...
                    <div data-aos="flip-left" className="z-0 h-[200px] w-[350px] p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col items-center">
                        <img src={figmalogo} className="w-[100px] h-[100px] " />
                        <a href="#">
                            <h5 className="mb-2 text-5xl font-semibold tracking-tight text-gray-900 dark:text-white text-center">Figma</h5>
                        </a>
